...
class SearchController {
  ...
  async search(req, res) {
    try {
        ...
        // Base filters (add your own filter logic as needed)
        let movieQuery = {};
        let tvseriesQuery = {};
        let tvChannelsQuery = {};

        if (q) {
          movieQuery.title = { $regex: q, $options: "i" };
          tvseriesQuery.title = { $regex: q, $options: "i" };
          tvChannelsQuery.name = { $regex: q, $options: "i" };
        }
