...
const { getChannelListController, createChannelController, updateChannelController, deleteChannelController, statusChannelController, getChannelInfoController } = require("../../controllers/mobileControllers/channel.controller");
